...
if ( ! function_exists( 'sample_theme_setup' ) ) :
	...
	function sample_theme_setup() {
		...
		register_nav_menus(
			array(
				'menu-primary' => esc_html__( 'Primary', 'sample-theme' ),
				'menu-secondary' => esc_html__( 'Secondary', 'sample-theme' ),
			)
		);
...
function sample_theme_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar Post', 'sample-theme' ),
			'id'            => 'sidebar-post',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar Main', 'sample-theme' ),
			'id'            => 'sidebar-main',
			'description'   => esc_html__( 'Add widgets here.', 'sample-theme' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
